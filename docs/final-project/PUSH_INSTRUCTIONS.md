...
- ✅ Final-project README created (`docs/final-project/README.md`)
...
- ✅ `docs/final-project/README.md` documents the final-project workflow
...
# Output will be in: docs/final-project/compiled/final_project_report.pdf
```
