...
**Repository location:** `docs/final-project/`
...
./compile_report.sh
# PDF output: docs/final-project/compiled/final_project_report.pdf
```
...
**Outputs:**
- `data/final-project/maps/house_map.pgm` - Occupancy grid image
- `data/final-project/maps/house_map.yaml` - Map metadata
...
│           └── metadata.yaml
├── docs/
│   ├── exercises/                   # Earlier Exercise 3/4 evidence
│   └── final-project/
...
│       ├── screenshots/             # Local-only images for report builds
│       └── compiled/                # Ignored PDF output directory
...
| `data/final-project/patrol/patrol_waypoints.yaml` | Saved patrol waypoints |
...
Output: `docs/final-project/compiled/final_project_report.pdf`
...
See `docs/final-project/README_REPORT.md` for detailed compilation instructions and troubleshooting.
...
**Location:** `docs/final-project/compiled/final_project_report.pdf` (after compilation)
...
**Main branch integration:** final-project content is organized under `docs/final-project/` and `data/final-project/`
