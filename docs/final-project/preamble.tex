...
\sloppy % Helps with overfull hboxes in technical documents with long strings
...
\newcommand{\MISSING}[1]{\colorbox{yellow}{\textbf{#1}}}
...
\usepackage[subfigure]{tocloft}  % subfigure option for compatibility with subfig package
