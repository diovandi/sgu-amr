...
def _default_waypoints_path() -> str:
    workspace_root = Path(os.environ.get("SGU_AMR_WORKSPACE", Path.cwd()))
    return str(workspace_root / "data" / "final-project" / "patrol" / "patrol_waypoints.yaml")


DEFAULT_WAYPOINTS_PATH = _default_waypoints_path()
