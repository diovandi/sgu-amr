...
def generate_launch_description():
    ...
    workspace_root = os.environ.get("SGU_AMR_WORKSPACE", os.getcwd())
    
    default_rviz_config = os.path.join(pkg_exercise_launch, "rviz", "patrol_analysis.rviz")
    default_map_path = os.path.join(workspace_root, "data", "final-project", "maps", "house_map.yaml")
    default_bag_path = os.path.join(workspace_root, "data", "final-project", "patrol")
    ...
    # Fallback to source path if not yet installed in share directory.
