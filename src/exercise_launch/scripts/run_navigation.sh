#!/bin/bash
# Launch script for Phase 4: Nav2 Navigation
# Custom rudimentary_bot simulation with EKF and Nav2 stack for autonomous navigation
...
# Launch Phase 4 (simulation + EKF + Nav2)
